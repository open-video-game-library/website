...
export declare const getPreview: () => any;
...
export declare function useContentDatabase(): Promise<any>;
export declare function generateNavigation(query: any): Promise<Array<NavItem>>;
